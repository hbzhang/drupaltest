...
switch($curPage)
{
	...
	case "sportclubs":
		...
		$bgImg = "/images/backgrounds/sportclubs.jpg";
		break;
	case "clubs":
		SetActiveTrailMenuItem("Sport Clubs", $main_menu);
		$bgImg = "/images/backgrounds/sportclubs.jpg";
	...
	<div id="main">
		...
		<div id="main-container">
			...
			<ul>
				...
				<li class="border"><a href="mailto:recsports@vt.edu">recsports@vt.edu</a>
				<li>540-231-6856</li>
			</ul>
			</div>
			<div class="clear"></div>
...
?>
	<p>
		&copy; 2011 Virginia Polytechnic Institute and State University | <a href="http://www.vt.edu/contacts/webmaster.php">Website Feedback</a> | <a href="<?php print $secureurl; ?>/user">User Login</a>
	</p>
</div>
</div>
<?php
